...
const StudentDashboard = () => {
  ...
  const Marks = async () => {
    await Axios.get(
      `http://localhost:5000/student/score/${localStorage.getItem("userID")}`
    )
    ...
    <div className="dashboard">
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <a className="nav-link" href="/loginTeacher">
                  SiginIn Teacher
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/signupTeacher">
                  Signup Teacher
                </a>
              </li>
              <li className="nav-item">
      ...
      <div className="student-info">
        ...
        <div className="student-class">
          <h2 className="fas fa-chalkboard-teacher">
            {" "}
      ...
      <div className="student-score-container">
        <div className="student-score">{score}</div>
      </div>
      ...
      <div className="student-counselling-container">
        <div className="student-counselling">
          <a className="btn btn-success button1" href="/form2">
            Dropout
          </a>
          <a className="btn btn-primary button2 " href="/form1">
            Career predictor
          </a>
        </div>
      </div>
